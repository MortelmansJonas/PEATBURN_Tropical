...
fig, ax = plt.subplots(nrows=2, ncols=1, figsize=figsize, dpi=300)
...
ax[1].set_title('Ignitions on peatland [yr$^{-1}$ km$^{-2}$]', fontsize=font_subtitle)  # set title of subfigure
