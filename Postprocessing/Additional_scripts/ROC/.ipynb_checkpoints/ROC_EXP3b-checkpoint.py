...
axes[0].plot(fpr_EXP3b_nat, tpr_EXP3b_nat, color=color_exp, ls=ls_exp,
             label='FWI$_{peat}$ (AUC = %0.2f)' % auc_EXP3b_nat)
...
axes[1].plot(fpr_EXP3b_dra, tpr_EXP3b_dra, color=color_exp, ls=ls_exp,
             label='FWI$_{peat}$ (AUC = %0.2f)' % auc_EXP3b_dra)
